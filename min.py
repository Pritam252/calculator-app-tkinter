...
def window(root):
    ...
    mCmdBox.config(background="#03e8fc")
    mResBox = calcbox(root, 0, 1)
    mResBox.config(background="#03fc90")
    ...
    numpad = [(7, 0, 3), (8, 1, 3), (9, 2, 3),(4, 0, 4), (5, 1, 4), (6, 2, 4),(1, 0, 5), (2, 1, 5), (3, 2, 5),('-', 0, 6), (0, 1, 6), ('.', 2, 6),('(', 0, 7),(')', 1, 7),(',', 2, 7)]
